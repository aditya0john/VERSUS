        ...
        <form>
          <div className="p-3 flex gap-2">
            <input
              ...
              className="bg-white text-white rounded-2xl border border-black p-2 w-full font-semibold change placeholder:text-black/[0.4] hover:placeholder-white"
              type="text"
    ...
    <>
      <div>
        <form>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:m-10">
            {Course.filter((items) => {

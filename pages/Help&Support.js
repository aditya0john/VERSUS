...
export default function Courses() {
      ...
      <main>
        ...
        <div className="body gap-4 bg-white rounded-lg flex flex-col items-center p-3">
          <div className="bg-gray-200 rounded-lg w-full p-2">
            <p className="text-black text-4xl font-bold text-uppercase flex justify-center p-2">
              complaint form
            </p>
            ...
            <form className="grid grid-cols-2 gap-2 p-2">
              <div className="flex flex-col gap-2">
                <input
                  type="text"
                  className="bg-white text-black rounded-md border border-black p-2 w-full change placeholder-black hover:placeholder-white"
                  placeholder="NAME"
                />
                <input
                  type="email"
              ...
              >
                ...
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  class="hidden md:block w-20 h-20"
                >
                  <path
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-3">
            <div className="bg-gray-200 p-2 rounded-lg w-full ">
              <ul className="text-2xl font-bold text-black uppercase flex justify-center p-2">
                contact us
              </ul>
              <hr className="border border-black" />
              <ul class="wrapper">
  ...
  return (
    <main>
      ...
      <div className="body bg-white rounded-lg flex flex-col items-center p-3">
        <div className="bg-gray-100 p-2 rounded-lg w-full mb-3">

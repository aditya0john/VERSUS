...
function LogIn() {
  ...
  return (
    <>
      ...
      <div className="md:grid md:body md:grid-cols-2">
        <div className="hidden md:border md:border-black md:flex md:flex-col md:m-4 md:rounded-lg md:justify-center md:items-center">

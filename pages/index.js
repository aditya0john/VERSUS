                ...
                <div className="grid">
                  <div className="grid grid-rows-2">
                    ...
                    <h3 className="shdg text-gray-400 ">
                      Comprehensive remote Assessment platform with support for
                      a variety of tests & an ultra-powerful remote proctoring
                  ...
                  <ol className="text-black">
                    ...
                    <li>
                      • Automatic blocking of bad actors with complete control
                      for proctor to extend or terminate the test
                    </li>
                    <li>
                      • Over 200 knobs to design and schedule tests from a
                      variety of auto-evaluated and manually evaluated question
                      types
                    </li>
                    <li>
                      • Auto-evaluated question types include computer
                      programming in multiple languages, variants of multiple
                      choice, fill in the blanks, numerical type, match columns,
                      spoken english, reading comprehension, listening
                      comprehension, etc.
                    </li>
                    <li>
              ...
              <div className="scale-95 grid grid-cols-2 items-center h-screen">
                ...
                <div>
                  ...
                  <ol className="text-black">
                    ...
                    <li>
                      • Curriculum management, controllable at individual as
                      well as organization hierarchy level
                    </li>
                    <li>
